...
module.exports = async done => {
  try {
    ...
    console.log('In frontend/src/sushi/lib/constants.js scroll to CHAIN_ID 97 (bsc_testnet)')
    console.log(`\nPaste this ${pairAddress} LP token address into supportedPools/lpAddresses and...      .env !`)
